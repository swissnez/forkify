...
class RecipeView extends View {
    ...
    addHandleUpdateServings(handler) {
        this._parentElement.addEventListener("click", function (e) {
            ...
            if (+updateTo > 0) handler(+updateTo);// the + converts string to number :) 
        });
    }
    ...
    _generateMarkup() {
    //this._clear(); // Remove spinner before markup render 
    return `
    ...
    _generateMarkupIngredient(i) {
            ...
            <div class="recipe__quantity">${i.quantity ? new Fraction(i.quantity).toString(): ""}</div>
